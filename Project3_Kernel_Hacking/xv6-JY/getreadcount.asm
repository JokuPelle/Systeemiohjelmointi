  ...
  11:	83 39 01             	cmpl   $0x1,(%ecx)
{
  ...
  27:	e8 16 03 00 00       	call   342 <getreadcount>
  exit();
  2c:	e8 71 02 00 00       	call   2a2 <exit>
    printf(2,"Error:\nThis system call requires one argument.\nThis argument should either be:\n0,    if you want to keep the current system call counter.\n1-22, to reset the counter to a new system call number.\n23,   if you want to reset the counter.\n\n");
  31:	50                   	push   %eax
  32:	50                   	push   %eax
  33:	68 48 07 00 00       	push   $0x748
  38:	6a 02                	push   $0x2
  3a:	e8 b1 03 00 00       	call   3f0 <printf>
    exit(); }
 ...
 359:	85 d2                	test   %edx,%edx
{
 ...
 387:	f7 f1                	div    %ecx
 389:	0f b6 92 3c 08 00 00 	movzbl 0x83c(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, const char *fmt, ...)
{
 ...
 5a4:	e9 8f fe ff ff       	jmp    438 <printf+0x48>
          s = "(null)";
 5a9:	bb 34 08 00 00       	mov    $0x834,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 5c1:	a1 e0 0a 00 00       	mov    0xae0,%eax
{
 ...
 5fd:	89 08                	mov    %ecx,(%eax)
  freep = p;
 5ff:	a3 e0 0a 00 00       	mov    %eax,0xae0
}
 604:	5b                   	pop    %ebx
 605:	5e                   	pop    %esi
 606:	5f                   	pop    %edi
 ...
 616:	72 ce                	jb     5e6 <free+0x26>
{
 ...
 637:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 63a:	a3 e0 0a 00 00       	mov    %eax,0xae0
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 659:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 65c:	8b 15 e0 0a 00 00    	mov    0xae0,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 69f:	73 47                	jae    6e8 <malloc+0x98>
    ...
    if(p == freep)
 6a1:	39 05 e0 0a 00 00    	cmp    %eax,0xae0
 ...
 6c6:	e8 f5 fe ff ff       	call   5c0 <free>
  return freep;
 6cb:	8b 15 e0 0a 00 00    	mov    0xae0,%edx
 ...
 6f4:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 6f7:	89 15 e0 0a 00 00    	mov    %edx,0xae0
}
 ...
 709:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 710:	c7 05 e0 0a 00 00 e4 	movl   $0xae4,0xae0
 717:	0a 00 00 
 71a:	c7 05 e4 0a 00 00 e4 	movl   $0xae4,0xae4
 721:	0a 00 00 
    base.s.size = 0;
 724:	b8 e4 0a 00 00       	mov    $0xae4,%eax
 729:	c7 05 e8 0a 00 00 00 	movl   $0x0,0xae8
 730:	00 00 00 
